...
# Run scripts.
python train.py "efficientnetb0" --da 2
python test.py "submission.csv" "efficientnetb0" \
...
RESULTS_FOLDER="$HOME/ismi-camelyon/results/4-efficientnetb0-da-tta/$(date '+%Y%m%dT%H%M%S')"
